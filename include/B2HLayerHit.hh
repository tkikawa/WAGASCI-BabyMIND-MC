...
{
public:
  //B2HLayerHit(G4int, G4int, G4int, G4double, G4double, const G4ThreeVector&, G4double);
  B2HLayerHit(G4int, G4int, G4int, G4double, G4double, G4ThreeVector, G4double);
  B2HLayerHit(G4int, G4double, G4int, const G4ThreeVector&);
  B2HLayerHit(G4int, G4double, G4int);
  B2HLayerHit(G4int, G4double);
  
  ~B2HLayerHit();
  B2HLayerHit(const B2HLayerHit &right);

...
{
public:
  //B2VetoHit(G4int, G4int, G4int, G4double, const G4ThreeVector&, G4double);
  B2VetoHit(G4int, G4int, G4int, G4double, G4double, G4ThreeVector, G4double);
  B2VetoHit(G4int, G4double, G4int);
  B2VetoHit(G4int, G4double);

  ~B2VetoHit();
  //copy constructor & assignment operator
  B2VetoHit(const B2VetoHit &right);

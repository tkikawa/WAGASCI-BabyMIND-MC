...
{
public:
  //B2VLayerHit(G4int, G4int, G4int, G4double, const G4ThreeVector&, G4double);
  B2VLayerHit(G4int, G4int, G4int, G4double, G4double, G4ThreeVector, G4double);
  B2VLayerHit(G4int, G4double, G4int);
  B2VLayerHit(G4int, G4double);
  
  ~B2VLayerHit();
  B2VLayerHit(const B2VLayerHit &right);

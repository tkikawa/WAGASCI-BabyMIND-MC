...
B2RunAction::B2RunAction(char* output)
{
  time_t timer;
  strcpy(file,output);
  ...
  evt = new B2EventSummary();

  tree = new TTree("tree","Tree");
  h1 = new TTree("h1","Tree");//for t2kreweight
  
  tree->Branch("fDefaultReco.","B2EventSummary",&evt,64000,99);
...
////////////////////////////////////////////////////
{ 
  //G4cout << " Not Entry to B2 detectors " << NotEntry << G4endl;
